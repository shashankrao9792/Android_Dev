...
public class HumidityActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sensor = lSensorManager.getDefaultSensor(Sensor.TYPE_RELATIVE_HUMIDITY);
        if(sensor == null){
            Log.e("Humidity Activity", "Humidity Sensor not found");
    ...
    private SensorEventListener mySensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            if(event.sensor.getType() == Sensor.TYPE_RELATIVE_HUMIDITY){
                TextView textView = (TextView) findViewById(R.id.humidity_text2);
        ...
        public void onAccuracyChanged(Sensor sensor, int accuracy) {
            ...
            Toast.makeText(HumidityActivity.this, accuracyMsg, Toast.LENGTH_SHORT).show();
        }
    };
