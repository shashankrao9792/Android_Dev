...
public class PressureActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sensor = lSensorManager.getDefaultSensor(Sensor.TYPE_PRESSURE);
        if(sensor == null){
            Log.e("Pressure Activity", "Pressure Sensor not found");
    ...
    private SensorEventListener mySensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            if(event.sensor.getType() == Sensor.TYPE_PRESSURE){
                TextView textView = (TextView) findViewById(R.id.pressure_text2);
        ...
        public void onAccuracyChanged(Sensor sensor, int accuracy) {
            ...
            Toast.makeText(PressureActivity.this, accuracyMsg, Toast.LENGTH_SHORT).show();
        }
    };
